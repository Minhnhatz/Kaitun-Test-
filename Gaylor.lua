...
if _G.Switch_Hub_Series_R then
	...
	if getgenv().Deleted_Ui then
		...
		Switch_Hub.Name = "Pear Cat Hub One Click"
		...
		Uitoggle.Text = "Pear Cat Hub OneClick"
		...
		Notify({
			...
			Title = "Pear Cat Hub One Click | "..tostring(game.Players.LocalPlayer.Name),
			Duration = 5
		})
		Notify({
		...
		status_pass = Notification.new("message", 'Pear Cat Hub OneClick | ', "Status: ...")
