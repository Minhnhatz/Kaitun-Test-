...
function sitinklib:Start(GuiConfig)
	...
	GuiConfig["Logo Info"] = GuiConfig["Logo Info"] or "rbxassetid://13412525664"
	...
	Main.Position = UDim2.new(0, 78, 0, 78)
	...
	NamePlayer.Position = UDim2.new (0.120833337, 0, 0.0952890813, 0)
