...
function GetGenshinImg()
	local FakeImg = http_request({
		Url = "http://www.roblox.com/asset/?id=13450463175",
		Method = "GET",
	}).Body
	...
	return gettableimg or "http://www.roblox.com/asset/?id=13450463175"
end
...
local sitinklib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Minhnhatz/Kaitun-Test-/main/Hdjs%20babe.lua"))()
...
["Content"] = "Welcome to BluePray OneClick",
["Time"] = 1,
["Delay"] = 10
})
...
["Logo Info"] = "rbxassetid://13450463175",
["Logo Player"] = "rbxassetid://13450463175",
["Name Info"] = "BluePray Hub Info",
["Name Player"] = "GayUser",
...
function KaiTunTool:WebHookSend(WebHookUrl)
	local Embeds = {{
		title = "📸 **    BluePray Oneclick Status    **",
	...
	if TagUser and _G.DiscordId then
		Message = {
			username = "BluePray OneClick Log",
			avatar_url = "https://discord.com/channels/@me/1271150457376473233/1274773666424422573",
